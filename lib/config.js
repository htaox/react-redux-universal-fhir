...
export const NATIVE_TYPES = /^(xhtml|uuid|uri|id|code|markdown|oid|string|time|date|dateTime|instant|integer|decimal|unsignedInt|positiveInt|base64Binary|boolean)$/i;
