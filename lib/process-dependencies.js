...
const schemaSequenceFile = `${DEPENDENCIES_DEST}/importSchemaSequence.json`;
...
export class ProcessDependencies {
  ...
  exportDeps() {
    ...
    fs.writeFileSync(schemaSequenceFile, JSON.stringify(this.processSequence, null, '  ') ,{ encoding: 'utf8' });
    return this;
  }
