...
const processSequenceFile = `${DEPENDENCIES_DEST}/processSequence.json`;
...
export class ProcessDependencies {
  ...
  exportDeps() {
    ...
    fs.writeFileSync(processSequenceFile, JSON.stringify(this.processSequence, null, '  ') ,{ encoding: 'utf8' });
    return this;
  }
